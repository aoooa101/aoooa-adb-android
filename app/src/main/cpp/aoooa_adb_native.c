...
Java_com_aoooa_adb_native_AdbNative_buildCnxnPacket(
    JNIEnv *env,
    jobject thiz,
    jint version,
    jint max_payload,
...
JNIEXPORT jbyteArray JNICALL
Java_com_aoooa_adb_native_AdbNative_encodeRsaPublicKey(
    JNIEnv *env,
    jobject thiz,
...
Java_com_aoooa_adb_native_AdbNative_calculateChecksum(
    JNIEnv *env,
    jobject thiz,
...
Java_com_aoooa_adb_native_AdbNative_nativePair(
    JNIEnv *env,
    jobject thiz,
    jstring host_jstr,
    jint port,
