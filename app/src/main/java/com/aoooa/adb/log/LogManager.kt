...
object LogManager {
    ...
    fun init() {
        try {
            logSource.value = if (com.aoooa.adb.Prefs.logSource == 1) LogSource.TARGET_APPS else LogSource.FULL_DEVICE
            filterMode.value = when (com.aoooa.adb.Prefs.logFilterMode) {
                1 -> FilterMode.WHITELIST
                2 -> FilterMode.BLACKLIST
                else -> FilterMode.NONE
            }
            bufferMode.value = LogBufferMode.fromPref(com.aoooa.adb.Prefs.logBufferMode)
            includeHistory.value = com.aoooa.adb.Prefs.logIncludeHistory
            historyLines.value = com.aoooa.adb.Prefs.logHistoryLines
            minLevel.value = com.aoooa.adb.Prefs.logMinLevel
            maxBufferLines.value = com.aoooa.adb.Prefs.logMaxBufferLines
            enabledLevelsMask.value = com.aoooa.adb.Prefs.logEnabledLevelsMask
            typeFilter.value = LogTypeFilter.fromPref(com.aoooa.adb.Prefs.logTypeFilter)
            tagInclude.value = com.aoooa.adb.Prefs.logTagInclude
            tagExclude.value = com.aoooa.adb.Prefs.logTagExclude
            keywordInclude.value = com.aoooa.adb.Prefs.logKeywordInclude
            keywordExclude.value = com.aoooa.adb.Prefs.logKeywordExclude
            useRegex.value = com.aoooa.adb.Prefs.logUseRegex
            highlightSpecial.value = com.aoooa.adb.Prefs.logHighlightSpecial
            whitelist.clear()
            whitelist.addAll(com.aoooa.adb.Prefs.loadLogWhitelist())
            blacklist.clear()
            blacklist.addAll(com.aoooa.adb.Prefs.loadLogBlacklist())
        } catch (e: Exception) {
    ...
    fun saveSettings() {
        try {
            com.aoooa.adb.Prefs.logSource = if (logSource.value == LogSource.TARGET_APPS) 1 else 0
            com.aoooa.adb.Prefs.logFilterMode = when (filterMode.value) {
                FilterMode.WHITELIST -> 1
                FilterMode.BLACKLIST -> 2
                else -> 0
            }
            com.aoooa.adb.Prefs.logBufferMode = bufferMode.value.prefValue
            com.aoooa.adb.Prefs.logIncludeHistory = includeHistory.value
            com.aoooa.adb.Prefs.logHistoryLines = historyLines.value
            com.aoooa.adb.Prefs.logMinLevel = minLevel.value
            com.aoooa.adb.Prefs.logMaxBufferLines = maxBufferLines.value
            com.aoooa.adb.Prefs.logEnabledLevelsMask = enabledLevelsMask.value
            com.aoooa.adb.Prefs.logTypeFilter = typeFilter.value.prefValue
            com.aoooa.adb.Prefs.logTagInclude = tagInclude.value
            com.aoooa.adb.Prefs.logTagExclude = tagExclude.value
            com.aoooa.adb.Prefs.logKeywordInclude = keywordInclude.value
            com.aoooa.adb.Prefs.logKeywordExclude = keywordExclude.value
            com.aoooa.adb.Prefs.logUseRegex = useRegex.value
            com.aoooa.adb.Prefs.logHighlightSpecial = highlightSpecial.value
            com.aoooa.adb.Prefs.saveLogWhitelist(whitelist.toList())
            com.aoooa.adb.Prefs.saveLogBlacklist(blacklist.toList())
        } catch (e: Exception) {
