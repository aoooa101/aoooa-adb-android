...
class PairingActionReceiver : BroadcastReceiver() {
    ...
    companion object {
        const val ACTION_PAIRING_SUBMIT = "com.aoooa.adb.ACTION_PAIRING_SUBMIT"
        const val ACTION_PAIRING_STOP = "com.aoooa.adb.ACTION_PAIRING_STOP"
