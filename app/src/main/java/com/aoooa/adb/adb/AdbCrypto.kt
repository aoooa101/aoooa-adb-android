...
class AdbCrypto(context: Context? = null) {
     ...
     * 格式：<Base64(524B RSAPublicKey)> aoooa-adb@aoooa101
     */
    ...
    fun getKeyManager(): X509KeyManager {
        ...
        return object : X509KeyManager {
            override fun getClientAliases(keyType: String?, issuers: Array<out Principal>?): Array<String> = arrayOf("aoooa-adb")
            override fun chooseClientAlias(keyType: Array<out String>?, issuers: Array<out Principal>?, socket: Socket?): String = "aoooa-adb"
            override fun getServerAliases(keyType: String?, issuers: Array<out Principal>?): Array<String> = arrayOf("aoooa-adb")
            override fun chooseServerAlias(keyType: String?, issuers: Array<out Principal>?, socket: Socket?): String = "aoooa-adb"
