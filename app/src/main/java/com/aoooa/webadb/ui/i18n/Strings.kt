...
object I18n {
    ...
    val zh = Strings(
        ...
        terminalModeAdb = "ADB 终端",
        terminalModeShellDesc = "设备原生远程 Shell 会话（保持不变）",
        terminalModeAdbDesc = "内置原生正版 ADB 交互式终端",
        terminalAdbPlaceholder = "输入 ADB 命令（如: adb devices, adb shell...）",
        terminalAdbHint = "内置原生 ADB 环境就绪，支持标准 adb 命令行交互",
        terminalAdbReady = "原生 ADB 就绪",
        // 配置与数据备份
    ...
    val en = Strings(
        ...
        terminalModeAdb = "ADB Terminal",
        terminalModeShellDesc = "Remote shell on target device (unchanged)",
        terminalModeAdbDesc = "Built-in native ADB interactive CLI",
        terminalAdbPlaceholder = "Type ADB command (e.g. adb devices, adb shell...)",
        terminalAdbHint = "Native ADB environment is ready. Standard ADB CLI supported.",
        terminalAdbReady = "Native ADB Ready",
        // 配置与数据备份
